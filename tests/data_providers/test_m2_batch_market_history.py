...
# ---------------------------------------------------------------------------
# Part C: D13 row equivalence �?batch path produces identical results
# ---------------------------------------------------------------------------
...
def test_d13_hy_ig_insufficient_history_gates_unchanged(tmp_path):
    ...
    """
    db_path = tmp_path / "mh.sqlite3"
    # Insert only 10 observations �?far below minimum of 60
    start = date(2026, 1, 1)
    for i in range(10):
...
# ---------------------------------------------------------------------------
# Part D: D14 row equivalence �?batch path produces identical results
# ---------------------------------------------------------------------------
