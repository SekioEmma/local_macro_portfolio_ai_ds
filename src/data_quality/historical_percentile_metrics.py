...
PRIMARY_CREDIT_OAS_METRICS = metadata.PRIMARY_CREDIT_OAS_METRICS
LONG_HISTORY_CREDIT_PROXY_REFERENCES = metadata.LONG_HISTORY_CREDIT_PROXY_REFERENCES
CREDIT_OAS_PROVIDER_REBUILD_STATUS = metadata.CREDIT_OAS_PROVIDER_REBUILD_STATUS
...
BROAD_BAND_LEVELS = metadata.BROAD_BAND_LEVELS
...
_alignment_label = metadata._alignment_label
_band_level = metadata._band_level
_normalization_methods_available = metadata._normalization_methods_available
_divergence_band = metadata._divergence_band
_divergence_notes = metadata._divergence_notes
_method_agreement = metadata._method_agreement
_reliability_drivers = metadata._reliability_drivers
_reliability_band = metadata._reliability_band
_reliability_metadata = metadata.build_reliability_metadata
_credit_oas_coverage_metadata = metadata.build_credit_oas_coverage_metadata
_history_coverage_status = metadata._history_coverage_status
_provider_rebuild_status = metadata._provider_rebuild_status
_normalization_availability = metadata._normalization_availability
_coverage_diagnostics = metadata._coverage_diagnostics
_credit_reference_role = metadata._credit_reference_role
_substitution_policy = metadata._substitution_policy
_long_history_reference_status = metadata._long_history_reference_status
_current_level_available = metadata._current_level_available
