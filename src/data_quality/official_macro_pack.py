...
OFFICIAL_MACRO_METRICS: dict[str, OfficialMacroMetric] = {
    ...
    "ppi_final_demand": OfficialMacroMetric(
        ...
        provider="research_needed",
        source_series=None,
        unit="percent",
        expected_frequency="monthly",
        status_when_missing="research_needed",
        missing_reason="PPI final demand series is not configured; do not use PPIACO as final demand.",
        interpretation_hint="PPI final demand remains research_needed until its official series id is verified; PPIACO is not final demand PPI.",
    ),
}
